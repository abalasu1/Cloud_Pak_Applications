package com.cargotracker.trackingms.application.internal.commandgateways;


import com.cargotracker.trackingms.domain.projections.TrackingProjection;
import com.cargotracker.trackingms.infrastructure.repositories.jpa.TrackingRepository;
