package com.cargotracker.bookingms.application.internal.sagaparticipants;

import com.cargotracker.bookingms.application.internal.commandgateways.CargoBookingService;
...
import com.cargotracker.bookingms.domain.events.CargoTrackedEvent;
...
public class BookingSagaManager {
    ...
    public void handle(CargoRoutedEvent cargoRoutedEvent){
        ...
        String random = UUID.randomUUID().toString(); // Generate a random tracking identifier
        String trackingId = random.substring(0, random.indexOf("-"));
